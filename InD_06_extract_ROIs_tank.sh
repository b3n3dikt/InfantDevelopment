...
do 
    ...
    for l in $(seq 1 6); do
        ...
        for i in $(seq 1 ${nROIs}); do 
            ...
            fslmaths ${inputatlas} -thr ${int} -uthr ${int} SARM_level-${l}_int-${int}_${nam}.nii.gz
            fslmaths ${warpfile} -mas SARM_level-${l}_int-${int}_${nam}.nii.gz tmpmasked.nii.gz
            meanROI=`fslstats tmpmasked.nii.gz -M`
            echo "${int},${nam},${abrv},${meanROI}" >> ${outpath}/${subses}_${outname}_mean_jacobian_ROI_values.csv
            echo "${sub},${subses},${int},${nam},${abrv},${meanROI}" >> ${outpath}/${outname}_mean_jacobian_ROI_values.csv
            echo "${sub},${subses},${int},${nam},${abrv},${meanROI}" >> ${outpath}/${outnamefull}_level-${l}_mean_jacobian_ROI_values.csv
    ...
    for l in $(seq 1 6); do
        ...
        for i in $(seq 1 ${nROIs}); do 
            ...
            fslmaths ${warpfile} -mas SARM_level-${l}_int-${int}_${abrv}.nii.gz tmpmasked.nii.gz
            meanROI=`fslstats tmpmasked.nii.gz -M`
