...
data_dir = [base_dir '/data/10k_GSR_runs_smoothed3mm'];
FD_dir = [base_dir '/data/motionFD_rad30_runs'];
%% parcellation
...
%% read in lists
fname = 'InD_lists/scan197_runs_data.list';
scan_list = textread(fname, '%s');
nscan = length(scan_list);

fname = 'InD_lists/scan197_run.list';
...
fname = 'InD_lists/scan197_runs_subject.list';
tmp = textread(fname, '%s');
...
fname = 'InD_lists/scan197_FD30.list';
